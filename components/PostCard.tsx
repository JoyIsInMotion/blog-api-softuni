...
export default function PostCard({
  ...
  return (
    <article className="group rounded-[2rem] border border-white/10 bg-slate-900/80 overflow-hidden shadow-2xl shadow-slate-950/20 transition hover:-translate-y-1 hover:border-sky-400/40">
      {post.coverImageUrl && (
